...
seq_len=15,patch_num=3,patch_dmodel=8,text_dmodel=768
流程是：

1. 每个时间点历史文本经过 BERT 编码生成1个768维文本向量（hCLS）：`[batch,C,text_len]-> [batch*C, 1, 768]*15->[batch*C, 15, 768]->[batch*C, 3, 768]`。
